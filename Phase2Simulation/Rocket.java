...
public class Rocket implements SpaceObject{
    ...
    public Rocket(double px, double py, double pz, double vx, double vy, double vz, double mass, double exhaustVelocity, double torque){
        position = new Vector(px, py, pz);
        velocity = new Vector(vx, vy, vz);
        this.mass = mass;
    }
    ...
    public void accalerate() {
        //TODO rocket speeds up with thrusters
    }
